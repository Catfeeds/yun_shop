...
class Admin extends AuthenticatableUser implements AuthenticatableContract{
     ...
     */ 
    protected $fillable = [ 
        'nickname', 'mobile', 'password', 'type','parent_id','active','member','member_end','account','shop_type','use_money','account_id','province','city'
    ]; 
    ...
    public function account(){
        return $this->belongsTo('App\Models\AccountInfo','account_id','id');
    }
    ...
    public function packagelog(){
        return $this->hasMany('App\Models\PackageLog');
    }
