...
class ProductController extends Controller
{
     ...
     *     @SWG\Response(
     *         response=200,
     *         description="status_code=0请求成功,status_code=1参数错误,data返回分类下的商品列表",
     *     ),
     *     @SWG\Response(
     *         response=500,
     *         description="服务器出错",
     ...
     *     @SWG\Response(
     *         response=200,
     *         description="status_code=0请求成功,status_code=1参数错误,data返回商品列表",
     *     ),
     *     @SWG\Response(
     *         response=500,
     *         description="服务器出错",
     ...
     *     @SWG\Response(
     *         response=200,
     *         description="status_code=0请求成功,status_code=1参数错误,data返回商品详情内容",
     *     ),
     *     @SWG\Response(
     *         response=500,
     *         description="服务器出错",
