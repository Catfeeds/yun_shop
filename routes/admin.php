...
Route::group(['middleware' => ['auth.admin:admin'], 'prefix' => 'zcjy', 'namespace' => 'Admin'], function () {
	...
	Route::group(['namespace' => 'Common'], function () {
		...
		//统计套餐
    	Route::get('package_statics','StaticController@index')->name('statics.package');
	...
	Route::get('selectShopRedirect/{shop_id}','Shop\StoreShopController@selectShopRedirect');
	/**
	 * 商户
	 */
	Route::group(['middleware' => 'role.shop', 'namespace' => 'Shop'], function () {
		...
		//提交审核
		Route::get('auth_mini_chat','MinichatBindController@auth')->name('minichat.auth');
		Route::post('ajax/mini_chat_sent_auth','MinichatBindController@ajaxAuth');
		Route::post('ajax/mini_chat_upload_code','MinichatBindController@ajaxUploadCode');
		Route::get('ajax/mini_chat_upload_code','MinichatBindController@ajaxUploadCodeGet');
